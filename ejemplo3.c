...
int main(){
    //altamente recomendable asigar un nulo a un apuntador al declararlo
    int *arreglo=NULL, *arreglo2=NULL, num, cont;
    printf("¿Cuántos elementos tiene el conjunto?\n");
    scanf("%d", &num);
    arreglo = (int*)malloc(num *sizeof(int)); //reserva memoria
    if(arreglo != NULL){        
        ...
        num *=2;
        arreglo2 = (int*)realloc(arreglo, num*sizeof(int)); //modifica el tamaño de una zona de memoria que ya se reservo
        //aountador de la zona de memoria que se desea cambiar
        //nuevo tamaño
        ...
        if(arreglo2 != NULL){ 
            ...
            printf("Vector reservado modificado:\n\t[");
